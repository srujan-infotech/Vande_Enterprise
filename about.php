...
<style>
    ...
    /* .about-2 .about-arrow {
        ...
        background-color: rgba(255,255,255,0.75); display: flex; align-items: center;
        justify-content: center; z-index: 3; color: #164243; font-size: 22px;
        box-shadow: 0 4px 16px rgba(0,0,0,0.15); animation: arrowPulse 2.2s ease-in-out infinite;
    } */
    ...
    @media (prefers-reduced-motion: reduce) {
        .blog-single-image img, .blog-single-text h5, .about-2 .about-text-card,
