...
(function ($) {
  ...
  if ($('.typed-text').length > 0) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
      var navbarEl = document.getElementById("architronixNavbar");

      if (navbarEl && typeof bootstrap !== "undefined") {
        navbarEl.querySelectorAll(".nav-link[href]:not([href='#'])").forEach(function (link) {
          link.addEventListener("click", function () {
            var offcanvas = bootstrap.Offcanvas.getInstance(navbarEl);
